...
> generated by a separate historical nesting pipeline outside the current v7 provenance, verified
...
> The completed v7 HUP direct-stream pooled 3D endpoint is 0/25 estimable with inference disabled;
> this historical single-subject contact analysis cannot replace it.
