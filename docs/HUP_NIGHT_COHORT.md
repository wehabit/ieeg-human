...
> and the estimates did not pass the current v7 provenance, raw-QC, or inference gates. See
> [ISSUE_REGISTER_2026-07.md](ISSUE_REGISTER_2026-07.md).
>
> **CURRENT V7 STATUS:** the cache manifest accounted for all 25 requested participants as 17
> completed, 8 structured skips, and 0 failures, with validated hashes. All four corrected 3A
> endpoints, both 3B stages, and direct-stream pooled 3D were each estimable in 0/25; 3D inference
> remains disabled. This withdraws the legacy numbers below but is not evidence of no biological
> effect and does not prove LC tracking.
